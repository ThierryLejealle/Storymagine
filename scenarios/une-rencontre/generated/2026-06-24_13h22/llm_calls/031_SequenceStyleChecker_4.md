...
PROBLEME: Le texte est trop dépendant de constructions nominalisées et d'adjectifs abstraits pour décrire des actions simples. Les transitions sont souvent mécaniques, et le narrateur explique trop ce que les personnages ressentent ou font plutôt que de laisser l'image parler d'elle-même. L'écriture manque de la concision et de la force verbale nécessaires à un style exigeant.
