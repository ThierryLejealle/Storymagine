 ...
 * ChatServiceImpl.representativeScene — the first present Npc, a simple default ; this agent isn't
 * tied to whoever last spoke).
 */
public record NextActReadinessAnalystInput(ChatScenario scenario, Npc speaker, int currentAct, String summary,
