 ...
 */
public class CharacterCritic implements Agent {
    ...
    private static final String AGENT_NAME = "CharacterCritic";
    ...
    public CharacterCritic(ModelCallPort llm) {
        this.llm = llm;
    }

    public CharacterCriticOutput call(CharacterCriticInput input) {
        ...
        return new CharacterCriticOutput(issues, score);
    }
}
