...
PROBLEME: Bien que le groupe soit décrit comme soudé par une routine silencieuse (le dortoir), il manque un élément de chaleur ou d'interaction sociale minimale entre les pilotes existants pour bien contraster avec l'isolement de Pierre, même si son isolement est très clair.
SCORE: 9