<!--
  Lore passif de l'histoire "as-du-ciel".
  Avions : descriptions factuelles et sensorielles, sans référence aux personnages.
  #PLAN  -> informations tactiques et techniques pour le planificateur
  #WRITER -> sensations, sons, aspects visuels pour le rédacteur
-->
...
Les deux Wright Cyclone produisent un grondement sourd et régulier, très différent du Merlin.
